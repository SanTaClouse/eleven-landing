...
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-3 left-3 z-[60] flex h-11 w-11 items-center justify-center rounded-full border border-[#25D366]/35 bg-ink/70 text-[#25D366] backdrop-blur transition-transform duration-200 hover:scale-110 md:bottom-5 md:left-5"
      style={{
